use {
    ...
    put_clap_utils::{self, hidden_unless_forced, input_validators::*, keypair::*},
    ...
    App::new(name)
        ...
        .arg(
            Arg::with_name("websocket_url")
                ...
                .global(true)
                .validator(is_url)
                .help("WebSocket URL for the put cluster"),
        )
        .arg(
        ...
        .subcommand(
            SubCommand::with_name("config")
                .about("PUT command-line tool configuration settings")
                .aliases(&["get", "set"])
                .setting(AppSettings::SubcommandRequiredElseHelp)
                .subcommand(
