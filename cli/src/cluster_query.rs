use {
    ...
    put_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient},
    put_rpc_client_api::{
...
impl ClusterQuerySubCommands for App<'_, '_> {
    fn cluster_query_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("supply").about("Get information about the cluster supply of PUT")
            .arg(
        ...
        .subcommand(
            SubCommand::with_name("total-supply").about("Get total number of PUT")
            ...
            SubCommand::with_name("rent")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display rent in lamports instead of PUT"),
                ),
        )
    }
}
...
pub fn process_catchup(
    ...
    loop {
        ...
        // especially if pointing to api.meinnet-beta.put.com at times
...
pub fn process_total_supply(rpc_client: &RpcClient, _config: &CliConfig) -> ProcessResult {
    ...
    Ok(format!("{} PUT", lamports_to_put(supply.total)))
}
...
pub fn process_show_stakes(
    ...
    let mut program_accounts_config = RpcProgramAccountsConfig {
        account_config: RpcAccountInfoConfig {
            encoding: Some(put_account_decoder::UiAccountEncoding::Base64),
...
mod tests {
    use {
        ...
        put_sdk::signature::{write_keypair, Keypair},
        std::str::FromStr,
