use {
    ...
    put_clap_utils::{self, input_parsers::*, input_validators::*, keypair::*},
    put_cli_output::{CliAddressLookupTable, CliAddressLookupTableCreated, CliSignature},
    put_remote_wallet::remote_wallet::RemoteWalletManager,
    put_rpc_client::rpc_client::RpcClient,
    put_rpc_client_api::config::RpcSendTransactionConfig,
    put_sdk::{
...
fn process_freeze_lookup_table(
    ...
    if !put_address_lookup_table_program::check_id(&lookup_table_account.owner) {
        return Err(format!(
