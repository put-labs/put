    ...
    fn stake_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-stake-account")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .required(true)
                        .help("The amount to send to the stake account, in PUT; accepts keyword ALL")
                )
                .arg(
            ...
            SubCommand::with_name("split-stake")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The amount to move into the new stake account, in PUT")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
        ...
        .subcommand(
            SubCommand::with_name("withdraw-stake")
                .about("Withdraw the unstaked PUT from the stake account")
                .arg(
                    pubkey!(Arg::with_name("stake_account_pubkey")
                        .index(1)
                        .value_name("STAKE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount_or_all)
                        .required(true)
                        .help("The amount to withdraw from the stake account, in PUT; accepts keyword ALL")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
...
pub fn parse_split_stake(
    ...
    let lamports = lamports_of_put(matches, "amount").unwrap();
    let seed = matches.value_of("seed").map(|s| s.to_string());
...
mod tests {
    ...
    fn test_parse_command() {
        ...
        let authorized = put_sdk::pubkey::new_rand();
        ...
        let vote_account_pubkey = put_sdk::pubkey::new_rand();
