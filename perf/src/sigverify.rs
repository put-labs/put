...
lazy_static! {
    static ref PAR_THREAD_POOL: ThreadPool = rayon::ThreadPoolBuilder::new()
        ...
        .thread_name(|i| format!("putSigVerify{i:02}"))
        .build()
        .unwrap();
}
...
fn check_for_simple_vote_transaction(
    ...
    if packet
        ...
        .ok_or(PacketError::InvalidLen)?
        == put_sdk::vote::program::id().as_ref()
    {
...
mod tests {
    ...
    fn test_pubkey_len() {
        ...
        use put_sdk::signer::{keypair::Keypair, Signer};
        put_logger::setup();
    ...
    fn test_is_simple_vote_transaction() {
        ...
        // multiple mixed tx is not
        {
            ...
            let tx = Transaction::new_with_compiled_instructions(
                ...
                &[key1, key2],
                Hash::default(),
                vec![put_vote_program::id(), Pubkey::new_unique()],
                vec![
