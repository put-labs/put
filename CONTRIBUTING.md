...
then about 1,000 lines of changes is about the most you should ask a PUT
...
is ready to be integrated, the PUT maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the PUT
...
PUT's architecture is described by docs generated from markdown files in
...
[Accepted Design Proposals](https://docs.put.com/proposals/accepted-design-proposals)
section of the PUT docs.  Here's the full process:
