...
//!
//! See also the PUT [documentation on the epoch schedule sysvar][sdoc].
//!
//! [sdoc]: https://docs.put.com/developing/runtime-facilities/sysvars#epochschedule
//!
//! # Examples
//!
...
//! # use put_sdk::sysvar::epoch_schedule::{self, EpochSchedule};
//! # use anyhow::Result;
//! #
