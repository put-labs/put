...
//!
//! [`getFeeForMessage`]: https://docs.put.com/developing/clients/jsonrpc-api#getfeeformessage
//! [ccf]: https://docs.put.com/proposals/comprehensive-compute-fees
//!
//! See also the Solana [documentation on the recent blockhashes sysvar][sdoc].
//!
//! [sdoc]: https://docs.put.com/developing/runtime-facilities/sysvars#recentblockhashes
