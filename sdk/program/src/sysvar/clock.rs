...
//!
//! See also the PUT [documentation on the clock sysvar][sdoc].
//!
//! [sdoc]: https://docs.put.com/developing/runtime-facilities/sysvars#clock
//!
//! # Examples
//!
...
//! # use put_sdk::sysvar::clock::{self, Clock};
//! # use anyhow::Result;
//! #
