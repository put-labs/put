...
//!
//! [rent]: https://docs.put.com/implemented-proposals/rent
//!
...
//!
//! See also the PUT [documentation on the rent sysvar][sdoc].
//!
//! [sdoc]: https://docs.put.com/developing/runtime-facilities/sysvars#rent
//!
//! # Examples
//!
...
//! }
//! #
//! # use put_program::sysvar::SysvarId;
//! # let p = Rent::id();
//! # let l = &mut 1009200;
...
//! # use put_sdk::sysvar::rent::{self, Rent};
//! # use anyhow::Result;
//! #
