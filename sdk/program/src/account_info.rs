...
use {
    crate::{
        ...
        program_error::ProgramError, program_memory::put_memset, pubkey::Pubkey,
    },
    std::{
...
impl<'a> AccountInfo<'a> {
    ...
    /// `put_program::entrypoint::MAX_PERMITTED_DATA_INCREASE` bytes.
    ///
    ...
    pub fn realloc(&self, new_len: usize, zero_init: bool) -> Result<(), ProgramError> {
        ...
        if zero_init {
            ...
            if len_increase > 0 {
                put_memset(&mut data[old_len..], 0, len_increase);
            }
        }
