...
//!
//! [na]: https://docs.put.com/implemented-proposals/durable-tx-nonces
//!
...
//!
//! [rent exempt]: https://docs.put.com/developing/programming-model/accounts#rent-exemption
//!
...
//!
//! [`RpcClient`]: https://docs.rs/put-client/latest/put_client/rpc_client/struct.RpcClient.html
//! [cpi]: crate::program
...
pub enum SystemError {
    ...
    AccountAlreadyInUse,
    #[error("account does not have enough PUT to perform the operation")]
...
///
/// ```
/// # use put_program::example_mocks::{put_sdk, put_rpc_client};
...
///
/// This example submits the instruction from an on-chain PUT program. The
...
/// ## Example: on-chain program
///
/// This example submits the instructions from an on-chain PUT program. The
...
///
/// Standard PUT transactions include a [recent blockhash][rbh] (sometimes
/// referred to as a _[nonce]_). During execution the PUT runtime verifies
...
///
/// [dtn]: https://docs.put.com/implemented-proposals/durable-tx-nonces
...
/// in the first position, the PUT runtime recognizes the transaction as one
...
/// [`put_rpc_client_nonce_utils::data_from_account`][dfa] function.
///
...
/// [dfa]: https://docs.rs/put-rpc-client-nonce-utils/latest/put_rpc_client_nonce_utils/fn.data_from_account.html
///
/// # Required signers
///
...
/// # use put_program::example_mocks::put_sdk;
/// # use put_program::example_mocks::put_rpc_client;
/// # use put_program::example_mocks::put_rpc_client_nonce_utils;
/// use put_rpc_client::rpc_client::RpcClient;
/// use put_sdk::{
///     message::Message,
///     pubkey::Pubkey,
...
///     let nonce_data = put_rpc_client_nonce_utils::data_from_account(&nonce_account)?;
...
///
/// [rent exemption]: https://docs.put.com/developing/programming-model/accounts#rent-exemption
///
