...
pub mod put_rpc_client {
    pub mod rpc_client {
        use {
            super::super::{
                put_rpc_client_api::client_error::Result as ClientResult,
                put_sdk::{
...
pub mod put_rpc_client_nonce_utils {
    use {
        super::put_sdk::{account::ReadableAccount, account_utils::StateMut, pubkey::Pubkey},
...
/// solana-program.
///
/// This lets examples in put-program appear to be written as client
/// programs.
pub mod put_sdk {
    pub use crate::{
...
pub mod put_address_lookup_table_program {
