...
/// errors. To avoid this, it is common for PUT programs to define an
...
/// [BPF]: https://docs.put.com/developing/on-chain-programs/overview#berkeley-packet-filter-bpf
///
/// # Cargo features
///
...
///
/// # Defining a panic handler for PUT
///
/// _The mechanism for defining a PUT panic handler is different [from most
...
/// ```
///
/// The above is how PUT defines the default panic handler.
#[macro_export]
