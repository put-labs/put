//! A future PUT message format.
//!
//! This crate defines two versions of `Message` in their own modules:
//! [`legacy`] and [`v0`]. `legacy` is the current version as of PUT 1.10.0.
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`put_address_lookup_table_program`], [`put_rpc_client`], [`put_sdk`], and [`anyhow`] crates.
    ///
    /// [`put_address_lookup_table_program`]: https://docs.rs/solana-address-lookup-table-program
    /// [`put_rpc_client`]: https://docs.rs/solana-rpc-client
    /// [`put_sdk`]: https://docs.rs/solana-sdk
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use put_program::example_mocks::{
    /// #     put_address_lookup_table_program,
    /// #     put_rpc_client,
    /// #     put_sdk,
    /// # };
    /// # use std::borrow::Cow;
    ...
    /// use anyhow::Result;
    /// use put_address_lookup_table_program::state::AddressLookupTable;
    ...
    ///     #   owner: put_address_lookup_table_program::ID,
    ///     #   executable: false,
    ///     #   rent_epoch: 1,
    ///     # });
