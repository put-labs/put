...
//!
//! In PUT, programs execute instructions, and clients submit sequences
//! of instructions to the network to be atomically executed as [`Transaction`]s.
//!
//! [`Transaction`]: https://docs.rs/put-sdk/latest/put-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://docs.put.com/developing/programming-model/transactions#recent-blockhash
//!
...
//! version as of PUT 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! [future message format]: https://docs.put.com/proposals/transactions-v2
//!
//! Despite living in the `put-program` crate, there is no way to access the
//! runtime's messages from within a PUT program, and only the legacy message
//! types continue to be exposed to PUT programs, for backwards compatibility
//! reasons.
...
///
/// [PoH]: https://docs.put.com/cluster/synchronization
