//! The original and current PUT message format.
//!
//! This crate defines two versions of `Message` in their own modules:
//! [`legacy`] and [`v0`]. `legacy` is the current version as of PUT 1.1.0.
...
/// A PUT transaction message (legacy).
///
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`put_sdk`], [`put_client`] and [`anyhow`] crates.
    ///
    /// [`put_sdk`]: https://docs.rs/put-sdk
    /// [`put_client`]: https://docs.rs/put-client
    /// [`anyhow`]: https://docs.rs/anyhow
    ///
    /// ```
    /// # use put_program::example_mocks::put_sdk;
    /// # use put_program::example_mocks::put_client;
    /// use anyhow::Result;
    ...
    ///
    /// [nonced transaction]: https://docs.put.com/implemented-proposals/durable-tx-nonces
    ///
    ...
    pub fn hash_raw_message(message_bytes: &[u8]) -> Hash {
        ...
        hasher.update(b"put-tx-message-v1");
...
mod tests {
    ...
    fn test_message_hash() {
        ...
        // in this case, the domain prefix `put-tx-message-v1` should be updated.
