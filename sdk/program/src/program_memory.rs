...
#[inline]
pub fn put_memcpy(dst: &mut [u8], src: &[u8], n: usize) {
...
#[inline]
pub unsafe fn put_memmove(dst: *mut u8, src: *mut u8, n: usize) {
    #[cfg(target_os = "solana")]
...
/// likely introduce undefined behavior.
#[inline]
pub fn put_memcmp(s1: &[u8], s2: &[u8], n: usize) -> i32 {
    let mut result = 0;
...
/// undefined behavior.
#[inline]
pub fn put_memset(s: &mut [u8], c: u8, n: usize) {
    #[cfg(target_os = "solana")]
    unsafe {
