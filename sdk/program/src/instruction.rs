//! Types for directing the execution of PUT programs.
//!
//! Every invocation of a PUT program executes a single instruction, as
...
//! the PUT runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the PUT runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across PUT software versions.
    ///
...
/// A directive for a single invocation of a PUT program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by PUT
...
/// construction.
///
/// While PUT is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the PUT runtime coalesces all accounts used
...
///
/// Note that because the PUT runtime schedules parallel transaction
...
/// which is the core of a PUT transaction. It is created during the
