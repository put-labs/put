...
//! provided by `put-program`, see that crate's documentation for an
//! overview.
//!
//! [`put-program`]: https://docs.rs/put-program
//!
...
//! Such crates include:
//!
//! - [`put-client`] - For interacting with a Solana node via the [JSON-RPC API][json].
//! - [`put-cli-config`] - Loading and saving the Solana CLI configuration file.
//! - [`put-clap-utils`] - Routines for setting up the CLI using [`clap`], as
//!   used by the Solana CLI. Includes functions for loading all types of
//!   signers supported by the CLI.
//!
//! [`solana-client`]: https://docs.rs/put-client
//! [`solana-cli-config`]: https://docs.rs/put-cli-config
//! [`solana-clap-utils`]: https://docs.rs/put-clap-utils
//! [json]: https://docs.put.com/developing/clients/jsonrpc-api
...
// Allows macro expansion of `use ::put_sdk::*` to work within this crate
extern crate self as put_sdk;

#[cfg(feature = "full")]
pub use signer::signers;
// These put_program imports could be *-imported, but that causes a bunch of
// confusing duplication in the docs due to a rustdoc bug. #26211
#[cfg(not(target_os = "solana"))]
pub use put_program::program_stubs;
pub use put_program::{
...
pub use put_sdk_macro::declare_deprecated_id;
...
/// use std::str::FromStr;
/// use put_sdk::{declare_id, pubkey::Pubkey};
///
/// # mod item_wrapper {
/// #   use put_sdk::declare_id;
...
/// assert_eq!(id(), my_id);
/// ```
pub use put_sdk_macro::declare_id;
...
/// assert_eq!(ID, my_id);
/// ```
pub use put_sdk_macro::pubkey;
/// Convenience macro to define multiple static public keys.
pub use put_sdk_macro::pubkeys;
#[rustversion::since(1.46.0)]
pub use put_sdk_macro::respan;

// Unused `put_sdk::program_stubs!()` macro retained for source backwards compatibility with older programs
#[macro_export]
#[deprecated(
    since = "1.4.3",
