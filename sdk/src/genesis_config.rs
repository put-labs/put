...
pub struct GenesisConfig {
    ...
    /// with the PUT v0.23 release line
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            ...
            "\
             ...
             {:?}\n\
             {:?}\n\
             Capitalization: {} PUT in {} accounts\n\
            ...
            lamports_to_put(
                self.accounts
                    ...
                    .map(|(pubkey, account)| {
                        ...
                        println!("key:{} put:{}",pubkey.to_string(),lamports_to_put(account.lamports));
                        account.lamports
                    })
                    .sum::<u128>()
            ),
...
mod tests {
    ...
    fn test_genesis_config() {
        ...
        config.add_native_instruction_processor("hi".to_string(), put_sdk::pubkey::new_rand());
    ...
    //         //if acc.executable {
    //             cnt += 1;
    //             println!("{}: key:{} put:{} : owner:{}",cnt,k,lamports_to_put(acc.lamports),acc.owner.to_string());
    //         //}
    //     });
