...
download() {
  #declare url="$1/$2/$3"
  declare url="http://182.140.244.175:3000/orca/lib/raw/commit/d66cf1b912ee4370770e7406d571a3f3fa30f532/platform-tools/v1.37/platform-tools-linux-x86_64.tar.bz2"
  declare filename=$3
  declare wget_args=(
    "$url" -O "$filename"
    "--progress=dot:giga"
...
if [[ ! -e platform-tools-$version.md || ! -e platform-tools ]]; then
  ...
  set +e
  rustup toolchain uninstall put
  set -e
  rustup toolchain link put platform-tools/rust
fi
