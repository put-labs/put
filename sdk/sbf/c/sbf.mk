...
help:
	@echo ''
	@echo 'Put VM Program makefile'
	@echo ''
	@echo 'This makefile will build Put Programs from C or C++ source files into ELFs'
	@echo ''
	@echo 'Assumptions:'
...
ifeq (,$(wildcard $(subst .so,-keypair.json,$1)))
	$(_@)put-keygen new --no-passphrase --silent -o $(subst .so,-keypair.json,$1)
endif
	@echo To deploy this program:
	@echo $$$$ put program deploy $(abspath $1)
endef
