...
use {
    ...
    put_sdk::clock::Slot,
    put_transaction_status::EncodeError,
    thiserror::Error,
};

// Keep in sync with https://github.com/put-labs/put-web3.js/blob/master/src/errors.ts
...
pub enum RpcCustomError {
    ...
    TransactionPrecompileVerificationFailure(put_sdk::transaction::TransactionError),
    #[error("SlotSkipped")]
