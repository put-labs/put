use {
    ...
    put_clap_utils::{
        input_parsers::{unix_timestamp_from_rfc3339_datetime,lamports_of_put},
...
fn fee_payer_arg<'a, 'b>() -> Arg<'a, 'b> {
    put_clap_utils::fee_payer::fee_payer_arg().required(true)
}
    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("url")
                ...
                .takes_value(true)
                .value_name("URL")
                .help("RPC entrypoint address. i.e. https://rpc.put.com"),
        )
        .subcommand(
            SubCommand::with_name("new")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("Amount to move into the new stake accounts, in PUT"),
                )
                .arg(
                    Arg::with_name("stake_authority")
                        .long("stake-authority")
...
fn parse_new_args(matches: &ArgMatches<'_>) -> NewArgs<String, String> {
    NewArgs {
        ...
        lamports: lamports_of_put(matches, "amount").unwrap(),
