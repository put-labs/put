...
fn spawn_unpack_snapshot_thread(
    ...
    Builder::new()
        .name(format!("putUnpkSnpsht{thread_index:02}"))
        .spawn(move || {
...
mod tests {
    ...
    fn test_roundtrip_bank_to_and_from_snapshot_complex() {
        ...
        let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports("1000000."));
        let bank0 = Arc::new(Bank::new_for_tests(&genesis_config));
        bank0
            .transfer(put_to_lamports("1."), &mint_keypair, &key1.pubkey())
            .unwrap();
        bank0
            .transfer(put_to_lamports("2."), &mint_keypair, &key2.pubkey())
            .unwrap();
        bank0
            .transfer(put_to_lamports("3."), &mint_keypair, &key3.pubkey())
            .unwrap();
        ...
        bank1
            ...
            .unwrap();
        bank1
            .transfer(put_to_lamports("4."), &mint_keypair, &key4.pubkey())
            .unwrap();
        bank1
            .transfer(put_to_lamports("5."), &mint_keypair, &key5.pubkey())
            .unwrap();
    ...
    fn test_incremental_snapshots_handle_zero_lamport_accounts() {
        ...
        let lamports_to_transfer = put_to_lamports("123456.");
