...
use {
    ...
    put_sdk::{
        ...
        native_loader,
        native_token::{put_to_lamports, LAMPORTS_PER_PUT},
    ...
    put_stake_program::stake_state::{self, StakeState},
    put_vote_program::{
        vote_instruction,
        vote_state::{
...
fn test_bank_new() {
    let dummy_leader_pubkey = put_sdk::pubkey::new_rand();
...
fn test_rent_distribution() {
    ...
    let bootstrap_validator_pubkey = put_sdk::pubkey::new_rand();
    ...
    let validator_1_pubkey = put_sdk::pubkey::new_rand();
    ...
    let validator_2_pubkey = put_sdk::pubkey::new_rand();
    ...
    let validator_3_pubkey = put_sdk::pubkey::new_rand();
...
fn test_distribute_rent_to_validators_overflow() {
    ...
    let validator_pubkey = put_sdk::pubkey::new_rand();
    let genesis_config =
...
fn test_distribute_rent_to_validators_rent_paying() {
    ...
    let genesis_config_info = create_genesis_config_with_vote_accounts(
        put_to_lamports("1000."),
        &keypairs,
        vec![put_to_lamports("1000."); 4],
    );
...
fn test_rent_exempt_executable_account() {
    ...
    let mut account = AccountSharedData::new(account_balance, 0, &put_sdk::pubkey::new_rand());
...
fn test_rent_eager_across_epoch_without_gap_under_multi_epoch_cycle() {
    let leader_pubkey = put_sdk::pubkey::new_rand();
...
fn test_rent_eager_collect_rent_in_partition() {
    ...
    for feature_id in FeatureSet::default().inactive {
        if feature_id != put_sdk::feature_set::set_exempt_rent_epoch_max::id() {
            activate_feature(&mut genesis_config, feature_id);
        }
    }

    let zero_lamport_pubkey = put_sdk::pubkey::new_rand();
    let rent_due_pubkey = put_sdk::pubkey::new_rand();
    let rent_exempt_pubkey = put_sdk::pubkey::new_rand();
    let mut bank = Arc::new(Bank::new_for_tests(&genesis_config));
    let zero_lamports = 0;
...
fn do_test_bank_update_rewards_determinism() -> u128 {
    ...
    let vote_id = put_sdk::pubkey::new_rand();
    let mut vote_account =
        vote_state::create_account(&vote_id, &put_sdk::pubkey::new_rand(), 0, 100);
    let stake_id1 = put_sdk::pubkey::new_rand();
    let stake_account1 = crate::stakes::tests::create_stake_account(123, &vote_id, &stake_id1);
    let stake_id2 = put_sdk::pubkey::new_rand();
...
fn test_purge_empty_accounts() {
    ...
    for pass in 0..3 {
        put_logger::setup();
        let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports("1."));
...
fn test_one_source_two_tx_one_batch() {
    let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports("1."));
    let key1 = put_sdk::pubkey::new_rand();
    let key2 = put_sdk::pubkey::new_rand();
    let bank = Bank::new_for_tests(&genesis_config);
    let amount = genesis_config.rent.minimum_balance(0);
    assert_eq!(bank.last_blockhash(), genesis_config.hash());
...
fn test_insufficient_funds() {
    let mint_amount = put_to_lamports("1.");
...
fn test_transfer_to_sysvar() {
    put_logger::setup();
    let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports(10_000.to_string().as_ref()));
    let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    let amount = genesis_config.rent.minimum_balance(0);

    let normal_pubkey = put_sdk::pubkey::new_rand();
...
fn test_bank_deposit() {
    ...
    // Test new account
    let key = put_sdk::pubkey::new_rand();
...
fn test_bank_tx_fee() {
    ...
    let leader = put_sdk::pubkey::new_rand();
    let GenesisConfigInfo {
        mut genesis_config,
        mint_keypair,
        ..
...
fn test_debits_before_credits() {
    let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports("2."));
    let bank = Bank::new_for_tests(&genesis_config);
    let keypair = Keypair::new();
...
fn test_readonly_accounts() {
    let GenesisConfigInfo {
        ...
        mint_keypair,
        ..
    } = create_genesis_config_with_leader(500, &put_sdk::pubkey::new_rand(), 0);
    let bank = Bank::new_for_tests(&genesis_config);

    let vote_pubkey0 = put_sdk::pubkey::new_rand();
    let vote_pubkey1 = put_sdk::pubkey::new_rand();
    let vote_pubkey2 = put_sdk::pubkey::new_rand();
...
fn test_readonly_relaxed_locks() {
    ...
    let key3 = put_sdk::pubkey::new_rand();
...
fn test_bank_parent_account_spend() {
    let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports("1.0"));
    let key1 = Keypair::new();
    let key2 = Keypair::new();
    let parent = Arc::new(Bank::new_for_tests(&genesis_config));
    let amount = genesis_config.rent.minimum_balance(0);
...
fn test_bank_hash_internal_state() {
    ...
    let pubkey2 = put_sdk::pubkey::new_rand();
...
fn test_bank_hash_internal_state_verify() {
    for pass in 0..3 {
        ...
        let bank2 = Bank::new_from_parent(&bank0, &put_sdk::pubkey::new_rand(), 1);
        ...
        let bank3 = Bank::new_from_parent(&bank0, &put_sdk::pubkey::new_rand(), 2);
...
fn test_hash_internal_state_order() {
    ...
    let bank1 = Bank::new_for_tests(&genesis_config);
    assert_eq!(bank0.hash_internal_state(), bank1.hash_internal_state());
    let key0 = put_sdk::pubkey::new_rand();
    let key1 = put_sdk::pubkey::new_rand();
...
fn test_hash_internal_state_error() {
    ...
    assert!(bank
        .transfer(put_to_lamports("1."), &mint_keypair, &key0)
        .is_err());
...
fn test_bank_update_sysvar_account() {
    ...
    for pass in 0..5 {
        ...
        let dummy_clock_id = put_sdk::pubkey::new_rand();
...
fn test_bank_inherit_tx_count() {
    ...
    // Bank 2
    let bank2 = Bank::new_from_parent(&bank0, &put_sdk::pubkey::new_rand(), 2);
    ...
    let bank6 = Bank::new_from_parent(&bank1, &put_sdk::pubkey::new_rand(), 3);
    assert_eq!(bank1.transaction_count(), 1);
    assert_eq!(bank1.non_vote_transaction_count_since_restart(), 1);
...
fn test_bank_vote_accounts() {
    let GenesisConfigInfo {
        ...
        mint_keypair,
        ..
    } = create_genesis_config_with_leader(500, &put_sdk::pubkey::new_rand(), 1);
    let bank = Arc::new(Bank::new_for_tests(&genesis_config));
...
fn test_bank_cloned_stake_delegations() {
    ...
    let (vote_balance, stake_balance) = {
        ...
        let minimum_delegation = put_stake_program::get_minimum_delegation(&bank.feature_set);
        (
...
fn test_is_delta_with_no_committables() {
    ...
    assert_eq!(
        bank.transfer(10_001, &mint_keypair, &put_sdk::pubkey::new_rand()),
        Err(TransactionError::InstructionError(
            0,
            SystemError::ResultWithNegativeLamports.into(),
        ))
...
fn test_bank_get_program_accounts() {
    ...
    assert!(
        genesis_accounts
            .iter()
            .any(|(pubkey, _, _)| put_sdk::sysvar::is_sysvar_id(pubkey)),
        "no sysvars found"
    );

    let bank0 = Arc::new(new_from_parent(&parent));
    let pubkey0 = put_sdk::pubkey::new_rand();
    ...
    let pubkey1 = put_sdk::pubkey::new_rand();
...
fn test_add_duplicate_static_program() {
    ...
    let vote_loader_account = bank.get_account(&put_vote_program::id()).unwrap();
    bank.add_mockup_builtin(put_vote_program::id(), process_instruction);
    let new_vote_loader_account = bank.get_account(&put_vote_program::id()).unwrap();
...
fn test_transaction_with_duplicate_accounts_in_instruction() {
    ...
    let from_pubkey = put_sdk::pubkey::new_rand();
    let to_pubkey = put_sdk::pubkey::new_rand();
    let dup_pubkey = from_pubkey;
    let from_account = AccountSharedData::new(put_to_lamports("100."), 1, &mock_program_id);
    ...
    let instruction =
        Instruction::new_with_bincode(mock_program_id, &put_to_lamports("10."), account_metas);
    let tx = Transaction::new_signed_with_payer(
        &[instruction],
    ...
    let result = bank.process_transaction(&tx);
    assert_eq!(result, Ok(()));
    assert_eq!(bank.get_balance(&from_pubkey), put_to_lamports("80."));
    assert_eq!(bank.get_balance(&to_pubkey), put_to_lamports("20."));
}
...
fn test_account_ids_after_program_ids() {
    ...
    let instruction = Instruction::new_with_bincode(put_vote_program::id(), &10, account_metas);
    let mut tx = Transaction::new_signed_with_payer(
        &[instruction],
        Some(&mint_keypair.pubkey()),
        &[&mint_keypair],
    ...
    tx.message.account_keys.push(put_sdk::pubkey::new_rand());
    ...
    let result = bank.process_transaction(&tx);
    assert_eq!(result, Ok(()));
    let account = bank.get_account(&put_vote_program::id()).unwrap();
...
fn test_program_id_as_payer() {
    ...
    tx.message.account_keys.push(put_vote_program::id());
...
fn test_same_program_id_uses_unqiue_executable_accounts() {
    ...
    // Add a new program
    let program1_pubkey = put_sdk::pubkey::new_rand();
    bank.add_mockup_builtin(program1_pubkey, process_instruction);

    // Add a new program owned by the first
    let program2_pubkey = put_sdk::pubkey::new_rand();
...
fn test_add_builtin_no_overwrite() {
    let slot = 123;
    let program_id = put_sdk::pubkey::new_rand();
...
fn test_add_builtin_loader_no_overwrite() {
    let slot = 123;
    let loader_id = put_sdk::pubkey::new_rand();
...
fn test_reconfigure_token2_native_mint() {
    ...
    let mut genesis_config =
        create_genesis_config_with_leader(5, &put_sdk::pubkey::new_rand(), 0).genesis_config;

    // ClusterType::Development - Native mint exists immediately
    assert_eq!(genesis_config.cluster_type, ClusterType::Development);
    let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    assert_eq!(
        bank.get_balance(&inline_ppl_token::native_mint::id()),
        1000000000
    );
    ...
    let bank = Arc::new(Bank::new_for_tests(&genesis_config));
    assert_eq!(bank.get_balance(&inline_ppl_token::native_mint::id()), 1000000000);
    bank.deposit(&inline_ppl_token::native_mint::id(), 4200000000)
        .unwrap();
    ...
    let native_mint_account = bank
        .get_account(&inline_ppl_token::native_mint::id())
        .unwrap();
    ...
    assert_eq!(native_mint_account.owner(), &inline_ppl_token::id());
...
fn test_bank_load_program() {
    ...
    let programdata_key = put_sdk::pubkey::new_rand();
...
fn test_bpf_loader_upgradeable_deploy_with_max_len() {
    ...
    let mut file = File::open("/app/orca/put/put_project/put/programs/bpf_loader/test_elfs/out/noop_aligned.so")
    .expect("file open failed");
    let mut elf = Vec::new();
    file.read_to_end(&mut elf).unwrap();
    ...
    let payer_base_balance = LAMPORTS_PER_PUT;
    let deploy_fees = {
    ...
    mock_process_instruction(
        ...
        Vec::new(),
        Ok(()),
        put_bpf_loader_program::process_instruction,
        |invoke_context| {
            invoke_context
        ...
        ) + std::marker::Send,
{
    ...
    // Set up initial bank
    let mut genesis_config =
        create_genesis_config_with_leader(10, &put_sdk::pubkey::new_rand(), 374_999_998_287_840)
            .genesis_config;
    ...
    let all_pubkeys: Vec<Pubkey> = std::iter::repeat_with(put_sdk::pubkey::new_rand)
        .take(total_pubkeys)
        .collect();
...
//     let GenesisConfigInfo {
//         mut genesis_config, ..
//     } = create_genesis_config_with_leader(42, &put_sdk::pubkey::new_rand(), 42);
...
fn test_get_largest_accounts() {
    ...
    assert_eq!(
        bank.get_largest_accounts(1, &pubkeys_hashset, AccountAddressFilter::Include)
            .unwrap(),
        vec![(pubkeys[4], put_to_lamports("5.0"))]
    );
    assert_eq!(
    ...
    assert_eq!(
        bank.get_largest_accounts(1, &exclude4, AccountAddressFilter::Exclude)
            .unwrap(),
        vec![(pubkeys[3], put_to_lamports("4.0"))]
    );
...
fn test_call_precomiled_program() {
    ...
    let instruction =
        put_sdk::secp256k1_instruction::new_secp256k1_instruction(&secp_privkey, message_arr);
    let tx = Transaction::new_signed_with_payer(
        &[instruction],
        Some(&mint_keypair.pubkey()),
        &[&mint_keypair],
    ...
    let message_arr = b"hello";
    let instruction =
        put_sdk::ed25519_instruction::new_ed25519_instruction(&privkey, message_arr);
    let tx = Transaction::new_signed_with_payer(
        &[instruction],
        Some(&mint_keypair.pubkey()),
        &[&mint_keypair],
...
fn test_an_empty_instruction_without_program() {
    ...
    let destination = put_sdk::pubkey::new_rand();
...
fn test_accounts_data_size_with_good_transaction() {
    ...
    let (genesis_config, mint_keypair) = create_genesis_config(put_to_lamports("1000."));
    let bank = Bank::new_for_tests(&genesis_config);
...
fn test_invalid_rent_state_changes_existing_accounts() {
    let GenesisConfigInfo {
        ...
        mint_keypair,
        ..
    } = create_genesis_config_with_leader(put_to_lamports("100."), &Pubkey::new_unique(), 42);
    genesis_config.rent = Rent::default();
...
fn test_rent_state_changes_sysvars() {
    ...
    let validator_pubkey = put_sdk::pubkey::new_rand();
    let validator_stake_lamports = put_to_lamports("1.");
...
fn test_invalid_rent_state_changes_fee_payer() {
    ...
    genesis_config.fee_rate_governor = FeeRateGovernor::new(
        put_sdk::fee_calculator::DEFAULT_TARGET_LAMPORTS_PER_SIGNATURE,
        put_sdk::fee_calculator::DEFAULT_TARGET_SIGNATURES_PER_SLOT,
    );
...
fn test_rent_state_incinerator() {
    ...
    for amount in [rent_exempt_minimum - 1, rent_exempt_minimum] {
        bank.transfer(amount, &mint_keypair, &put_sdk::incinerator::id())
            .unwrap();
    }
}
...
fn test_resize_and_rent() {
    ...
    let rent_paying_pubkey = put_sdk::pubkey::new_rand();
...
fn test_accounts_data_size_and_resize_transactions() {
    let GenesisConfigInfo {
        ...
        mint_keypair,
        ..
    } = genesis_utils::create_genesis_config(100 * LAMPORTS_PER_PUT);
    let mut bank = Bank::new_for_tests(&genesis_config);
    let mock_program_id = Pubkey::new_unique();
    bank.add_mockup_builtin(mock_program_id, mock_realloc_process_instruction);
    ...
    bank.store_account(
        &funding_keypair.pubkey(),
        &AccountSharedData::new(10 * LAMPORTS_PER_PUT, 0, &mock_program_id),
    );
    ...
    // Test case: Grow account
    {
        ...
        let account_balance = LAMPORTS_PER_PUT;
...
fn test_accounts_data_size_from_genesis() {
    let GenesisConfigInfo {
        ...
        1_000_000 * LAMPORTS_PER_PUT,
        &Pubkey::new_unique(),
        100 * LAMPORTS_PER_PUT,
    );
    genesis_config.rent = Rent::default();
...
fn test_cap_accounts_data_allocations_per_transaction() {
    ...
    let (genesis_config, mint_keypair) = create_genesis_config(1_000_000 * LAMPORTS_PER_PUT);
    let mut bank = Bank::new_for_tests(&genesis_config);
    ...
    assert_eq!(
        ...
        Err(TransactionError::InstructionError(
            ...
            put_sdk::instruction::InstructionError::MaxAccountsDataAllocationsExceeded,
        )),
    );
}
...
fn test_stake_account_consistency_with_rent_epoch_max_feature(
    ...
    put_logger::setup();
    let (mut genesis_config, _mint_keypair) = create_genesis_config(100 * LAMPORTS_PER_PUT);
    genesis_config.rent = Rent::default();
    let mut bank = Bank::new_for_tests(&genesis_config);
    let expected_initial_rent_epoch = if rent_epoch_max_enabled_initially {
        bank.activate_feature(&put_sdk::feature_set::set_exempt_rent_epoch_max::id());
...
fn test_runtime_feature_enable_with_program_cache() {
    ...
    // Bank Setup
    let (mut genesis_config, mint_keypair) = create_genesis_config(1_000_000 * LAMPORTS_PER_PUT);
    genesis_config
        .accounts
    ...
    F: Fn(&Bank),
{
    ...
    let mint_lamports = put_to_lamports("1.0");
    let len1 = 123;
    let len2 = 456;
...
fn test_system_instruction_unsigned_transaction() {
    let (genesis_config, alice_keypair) = create_genesis_config(put_to_lamports("1.0"));
    let alice_pubkey = alice_keypair.pubkey();
