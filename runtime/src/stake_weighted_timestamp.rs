...
pub mod tests {
    use {
        super::*,
        put_sdk::{account::Account, native_token::put_to_lamports},
    };
    ...
    fn test_calculate_stake_weighted_timestamp_uses_median() {
        ...
        let stakes: HashMap<Pubkey, (u128, Account)> = [
            (
                pubkey0,
                (put_to_lamports("1.0"), Account::new(1, 0, &Pubkey::default())),
            ),
            (
                pubkey1,
                (put_to_lamports("1.0"), Account::new(1, 0, &Pubkey::default())),
        ...
        let stakes: HashMap<Pubkey, (u128, Account)> = [
            (
                pubkey0,
                (
                    put_to_lamports("1000000.0"), // 1/3 stake
                    Account::new(1, 0, &Pubkey::default()),
                ),
            ),
            (
        ...
        let stakes: HashMap<Pubkey, (u128, Account)> = [
            (
                pubkey0,
                (
                    put_to_lamports("1000001.0"), // 1/3 stake
                    Account::new(1, 0, &Pubkey::default()),
                ),
            ),
            (
