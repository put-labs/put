...
/// is currently publicly communicated on put.com
pub const MAX_BLOCK_REPLAY_TIME_US: u64 = 400_000;
/// number of concurrent processes,
pub const MAX_CONCURRENCY: u64 = 4;

// Cluster data, method of collecting at https://github.com/put-labs/put/issues/19627
// Dashboard: https://metrics.put.com:8889/sources/0/dashboards/10?refresh=Paused&lower=now%28%29%20-%2012h
...
lazy_static! {
    ...
    pub static ref BUILT_IN_INSTRUCTION_COSTS: HashMap<Pubkey, u64> = [
        ...
        #[allow(deprecated)]
        (put_sdk::stake::config::id(), COMPUTE_UNIT_TO_US_RATIO * 2),
        (put_sdk::stake::program::id(), COMPUTE_UNIT_TO_US_RATIO * 25),
        (put_config_program::id(), COMPUTE_UNIT_TO_US_RATIO * 15),
        (put_vote_program::id(), COMPUTE_UNIT_TO_US_RATIO * 70),
        ...
        (put_address_lookup_table_program::id(), COMPUTE_UNIT_TO_US_RATIO * 25),
