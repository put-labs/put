...
pub use put_program::vote::state::{vote_state_versions::*, *};
use {
    log::*,
    serde_derive::{Deserialize, Serialize},
    put_metrics::datapoint_debug,
    put_program::vote::{error::VoteError, program::id},
    put_sdk::{
...
mod tests {
    ...
    fn create_test_account() -> (Pubkey, RefCell<AccountSharedData>) {
        ...
        let vote_pubkey = put_sdk::pubkey::new_rand();
        (
            vote_pubkey,
    ...
    //     let node_pubkey = put_sdk::pubkey::new_rand();
    //     let withdrawer_pubkey = put_sdk::pubkey::new_rand();
    ...
    //     assert_eq!(
    //         vote_state
    //             .set_new_authorized_voter(&put_sdk::pubkey::new_rand(), 0, 1, |_pubkey| Ok(()),),
    //         Ok(())
    //     );
    //     vote_state.increment_credits(1, 200);
    //     assert_eq!(
    //         vote_state
    //             .set_new_authorized_voter(&put_sdk::pubkey::new_rand(), 1, 2, |_pubkey| Ok(()),),
    //         Ok(())
    //     );
    //     vote_state.increment_credits(2, 300);
    //     assert_eq!(
    //         vote_state
    //             .set_new_authorized_voter(&put_sdk::pubkey::new_rand(), 2, 3, |_pubkey| Ok(()),),
    //         Ok(())
    //     );
    ...
    fn test_vote_double_lockout_after_expiration() {
        let voter_pubkey = put_sdk::pubkey::new_rand();
    ...
    fn test_process_missed_votes() {
        let account_a = put_sdk::pubkey::new_rand();
        let mut vote_state_a = vote_state_new_for_test(&account_a);
        let account_b = put_sdk::pubkey::new_rand();
