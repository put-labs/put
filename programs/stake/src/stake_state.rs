...
#[deprecated(
    since = "1.8.0",
    note = "Please use `put_sdk::stake::state` or `put_program::stake::state` instead"
)]
pub use put_sdk::stake::state::*;
use {
    ethnum::U256,
    put_program_runtime::{ic_msg, invoke_context::InvokeContext},
    put_sdk::{
...
pub fn delegate(
    ...
    if *vote_account.get_owner() != put_vote_program::id() {
...
pub(crate) fn deactivate_delinquent(
    ...
    if *delinquent_vote_account.get_owner() != put_vote_program::id() {
        return Err(InstructionError::IncorrectProgramId);
    }
    ...
    if *reference_vote_account.get_owner() != put_vote_program::id() {
        return Err(InstructionError::IncorrectProgramId);
    }
...
mod tests {
    use {
        super::*,
        proptest::prelude::*,
        put_program_runtime::with_mock_invoke_context,
        put_sdk::{
    ...
    fn test_authorized_authorize() {
        let staker = put_sdk::pubkey::new_rand();
    ...
    fn test_authorized_authorize_with_custodian() {
        ...
        let invalid_custodian = put_sdk::pubkey::new_rand();
        let mut authorized = Authorized::auto(&staker);
        let mut signers = HashSet::new();
        signers.insert(staker);
    ...
    fn test_stake_state_calculate_points_with_typical_values() {
        ...
        //  10_000_000 PUT is a big but not unreasaonable stake
        let stake = new_stake(
            native_token::put_to_lamports("10000000"),
            &Pubkey::default(),
            &vote_state,
            std::u64::MAX,
        );
    ...
    fn test_dbg_stake_minimum_balance() {
        ...
        panic!(
            ...
            minimum_balance,
            minimum_balance as f64 / put_sdk::native_token::LAMPORTS_PER_PUT as f64
        );
    }
    ...
    fn test_calculate_lamports_per_byte_year() {
        ...
        let even_larger_data = put_sdk::system_instruction::MAX_PERMITTED_DATA_LENGTH;
