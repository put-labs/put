...
use {
    itertools::izip,
    put_account_decoder::parse_bpf_loader::{
        parse_bpf_upgradeable_loader, BpfUpgradeableLoaderAccountType,
    },
    put_ledger::token_balances::collect_token_balances,
    put_program_runtime::{compute_budget::ComputeBudget, timings::ExecuteTimings},
    put_rbpf::vm::ContextObject,
    put_runtime::{
        bank::{
    ...
    put_sbf_rust_invoke::instructions::*,
    put_sbf_rust_realloc::instructions::*,
    put_sbf_rust_realloc_invoke::instructions::*,
    put_sdk::{
...
use {
    put_program_runtime::invoke_context::mock_process_instruction,
    put_runtime::{
        bank::Bank,
                        ...
                        inner_instructions
                            ...
                            .map(|(index, instructions)| InnerInstructions {
                                ...
                                instructions: instructions
                                    .into_iter()
                                    .map(|ix| put_transaction_status::InnerInstruction {
...
fn test_program_sbf_sanity() {
    ...
    {
        programs.extend_from_slice(&[
            ("put_sbf_rust_128bit", true),
            ("put_sbf_rust_alloc", true),
            ("put_sbf_rust_alt_bn128", true),
            ("put_sbf_rust_curve25519", true),
            ("put_sbf_rust_custom_heap", true),
            ("put_sbf_rust_dep_crate", true),
            ("put_sbf_rust_external_spend", false),
            ("put_sbf_rust_iter", true),
            ("put_sbf_rust_many_args", true),
            ("put_sbf_rust_membuiltins", true),
            ("put_sbf_rust_noop", true),
            ("put_sbf_rust_panic", false),
            ("put_sbf_rust_param_passing", true),
            ("put_sbf_rust_rand", true),
            ("put_sbf_rust_sanity", true),
            ("put_sbf_rust_secp256k1_recover", true),
            ("put_sbf_rust_sha", true),
        ]);
    }
...
fn test_program_sbf_loader_deprecated() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("put_sbf_rust_deprecated_loader")]);
    }
    ...
    for program in programs.iter() {
        ...
        genesis_config
            .accounts
            .remove(&put_sdk::feature_set::disable_deploy_of_alloc_free_syscall::id())
            .unwrap();
        let bank = Bank::new_for_tests(&genesis_config);
...
fn test_sol_alloc_free_no_longer_deployable() {
    ...
    let elf = load_program_from_file("put_sbf_rust_deprecated_loader");
    ...
    bank.deactivate_feature(&put_sdk::feature_set::disable_deploy_of_alloc_free_syscall::id());
    ...
    bank.activate_feature(&put_sdk::feature_set::disable_deploy_of_alloc_free_syscall::id());
    bank.clear_signatures();
...
fn test_program_sbf_duplicate_accounts() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("put_sbf_rust_dup_accounts")]);
    }
...
fn test_program_sbf_error_handling() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("put_sbf_rust_error_handling")]);
    }
...
fn test_return_data_and_log_data_syscall() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("put_sbf_rust_log_data")]);
    }
...
fn test_program_sbf_invoke_sanity() {
    ...
    for program in programs.iter() {
        ...
        let account_metas = vec![
            ...
            AccountMeta::new_readonly(put_sdk::ed25519_program::id(), false),
...
fn assert_instruction_count() {
    ...
    {
        programs.extend_from_slice(&[
            ("put_sbf_rust_128bit", 1218),
            ("put_sbf_rust_alloc", 5067),
            ("put_sbf_rust_custom_heap", 398),
            ("put_sbf_rust_dep_crate", 2),
            ("put_sbf_rust_iter", 1013),
            ("put_sbf_rust_many_args", 1289),
            ("put_sbf_rust_mem", 2067),
            ("put_sbf_rust_membuiltins", 1539),
            ("put_sbf_rust_noop", 275),
            ("put_sbf_rust_param_passing", 146),
            ("put_sbf_rust_rand", 378),
            ("put_sbf_rust_sanity", 51931),
            ("put_sbf_rust_secp256k1_recover", 91185),
            ("put_sbf_rust_sha", 24059),
        ]);
    }
        ...
        mock_process_instruction(
            ...
            |invoke_context| {
                *prev_compute_meter.borrow_mut() = invoke_context.get_remaining();
                put_bpf_loader_program::test_utils::load_all_invoked_programs(invoke_context);
            },
            |invoke_context| {
...
fn test_program_sbf_instruction_introspection() {
    ...
    let (bank, program_id) = load_program_and_advance_slot(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "put_sbf_rust_instruction_introspection",
    );
...
fn test_program_sbf_invoke_stable_genesis_and_bank() {
    ...
    load_upgradeable_program(
        ...
        &authority_keypair,
        "put_sbf_rust_invoke_and_return",
    );
...
fn test_program_sbf_disguised_as_sbf_loader() {
    ...
    #[cfg(feature = "sbf_rust")]
    {
        programs.extend_from_slice(&[("put_sbf_rust_noop")]);
    }
    ...
    for program in programs.iter() {
        ...
        feature_set.deactivate(&put_sdk::feature_set::native_programs_consume_cu::id());
        bank.feature_set = Arc::new(feature_set);
        bank.deactivate_feature(
            &put_sdk::feature_set::remove_bpf_loader_incorrect_program_id::id(),
        );
...
fn test_program_sbf_ro_account_modify() {
    ...
    let (bank, program_id) = load_program_and_advance_slot(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "put_sbf_rust_ro_account_modify",
    );
...
fn test_program_sbf_realloc() {
    ...
    for direct_mapping in [false, true] {
        ...
        assert_eq!(&put_sdk::system_program::id(), account.owner());
        let data = bank_client.get_account_data(&pubkey).unwrap().unwrap();
                    ...
                    Message::new(
                        &[Instruction::new_with_bytes(
                            ...
                            vec![
                                ...
                                AccountMeta::new(put_sdk::system_program::id(), false),
                            ],
                        )],
                        Some(&mint_pubkey),
                    )
                ...
                Message::new(
                    &[Instruction::new_with_bytes(
                        ...
                        vec![
                            AccountMeta::new(pubkey, true),
                            AccountMeta::new_readonly(realloc_program_id, false),
                            AccountMeta::new_readonly(put_sdk::system_program::id(), false),
                        ],
                    )],
                    Some(&mint_pubkey),
                )
...
fn test_program_sbf_processed_inner_instruction() {
    ...
    let sibling_program_id = load_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "put_sbf_rust_sibling_instructions",
    );
    let sibling_inner_program_id = load_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
        "put_sbf_rust_sibling_inner_instructions",
    );
...
fn test_get_minimum_delegation() {
    ...
    let (_, program_id) = load_program_and_advance_slot(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "put_sbf_rust_get_minimum_delegation",
    );
...
fn test_program_sbf_inner_instruction_alignment_checks() {
    ...
    let bank = Bank::new_for_tests(&genesis_config);
    let noop = create_program(&bank, &bpf_loader_deprecated::id(), "put_sbf_rust_noop");
    let inner_instruction_alignment_check = create_program(
        &bank,
        &bpf_loader_deprecated::id(),
        "put_sbf_rust_inner_instruction_alignment_check",
    );
