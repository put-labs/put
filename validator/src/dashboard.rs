use {
    ...
    console::style,
    put_core::validator::ValidatorStartProgress,
    put_rpc_client::rpc_client::RpcClient,
    put_rpc_client_api::{client_error, request, response::RpcContactInfo},
    put_sdk::{
        clock::Slot, commitment_config::CommitmentConfig, exit::Exit, native_token::PUT,
        pubkey::Pubkey,
    },
    std::{
        io,
...
fn get_validator_stats(
    ...
    identity: &Pubkey,
) -> client_error::Result<(Slot, Slot, Slot, u64, PUT, String)> {
