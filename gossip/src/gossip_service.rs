...
use {
    ...
    rand::{thread_rng, Rng},
    put_client::{connection_cache::ConnectionCache, thin_client::ThinClient},
    put_perf::recycler::Recycler,
...
pub fn discover(
    ...
    let _ip_echo_server = ip_echo
        .map(|tcp_listener| put_net_utils::ip_echo_server(tcp_listener, Some(my_shred_version)));
...
mod tests {
    ...
    fn test_gossip_services_spy() {
        ...
        let peer0 = put_sdk::pubkey::new_rand();
        let peer1 = put_sdk::pubkey::new_rand();
