use {
    ...
    bincode::deserialize,
    serde_json::Value,
    put_config_program::{get_config_data, ConfigKeys},
    put_sdk::{
        pubkey::Pubkey,
...
#[deprecated(
    since = "1.16.7",
    note = "Please use `put_sdk::stake::state::warmup_cooldown_rate()` instead"
)]
#[derive(Debug, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
mod test {
    use {
        ...
        put_config_program::create_config_account, put_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = put_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"PUT"}"#).unwrap(),
            }),
        );
