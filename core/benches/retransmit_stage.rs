...
extern crate put_core;
extern crate test;

use {
    crossbeam_channel::unbounded,
    log::*,
    put_core::retransmit_stage::retransmitter,
...
// the case since https://github.com/put-labs/put/pull/17716.
...
fn bench_retransmitter(bencher: &mut Bencher) {
    ...
    let retransmitter_handles = retransmitter(
        ...
        cluster_info,
        shreds_receiver,
        Arc::default(), // put_rpc::max_slots::MaxSlots
        None,
    );
