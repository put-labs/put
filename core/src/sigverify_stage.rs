...
use {
    ...
    put_sdk::timing,
    put_streamer::streamer::{self, StreamerError},
    std::{
...
impl SigVerifyStage {
    ...
    fn verifier<const K: usize, T: SigVerifier>(
        ...
        let non_discarded_packets = put_perf::discard::discard_batches_randomly(
            &mut batches,
            MAX_DEDUP_BATCH,
            num_packets,
        );
