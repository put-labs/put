use {
    ...
    put_ledger::blockstore_processor::{ConfirmationProgress, ConfirmationTiming},
    put_program_runtime::{report_execute_timings, timings::ExecuteTimingType},
    put_runtime::{bank::Bank, bank_forks::BankForks, vote_account::VoteAccountsHashMap},
    put_sdk::{clock::Slot, hash::Hash, pubkey::Pubkey},
    std::{
...
mod test {
    use {
        super::*,
        put_runtime::vote_account::VoteAccount,
        put_sdk::account::{Account, AccountSharedData},
    };

    fn new_test_vote_account() -> VoteAccount {
        let account = AccountSharedData::from(Account {
            owner: put_vote_program::id(),
            ..Account::default()
        });
    ...
    fn test_add_vote_pubkey() {
        ...
        let mut vote_pubkey = put_sdk::pubkey::new_rand();
        ...
        vote_pubkey = put_sdk::pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(put_sdk::pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = put_sdk::pubkey::new_rand();
        ...
        // shouldn't increase
        node_pubkey = put_sdk::pubkey::new_rand();
        stats.add_node_pubkey_internal(&node_pubkey, &vote_account_pubkeys, &epoch_vote_accounts);
        assert!(stats.propagated_node_ids.contains(&node_pubkey));
        assert_eq!(
            stats.propagated_validators_stake,
