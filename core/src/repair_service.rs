...
#[cfg(test)]
use {
    crate::duplicate_repair_status::DuplicateSlotRepairStatus, put_ledger::shred::Nonce,
    put_sdk::clock::DEFAULT_MS_PER_SLOT,
};
use {
    crate::{
    ...
    put_streamer::sendmmsg::{batch_send, SendPktsError},
    std::{
...
mod test {
    use {
        super::*,
        put_gossip::{cluster_info::Node, contact_info::ContactInfo},
        put_ledger::{
            blockstore::{
