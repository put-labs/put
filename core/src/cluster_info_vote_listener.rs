use {
    ...
    put_metrics::inc_new_counter_debug,
    put_perf::packet,
...
mod tests {
    use {
        ...
        put_vote_program::{vote_state::Vote, vote_transaction},
        std::{
    ...
    fn test_update_new_root() {
        ...
        let new_voter = put_sdk::pubkey::new_rand();
