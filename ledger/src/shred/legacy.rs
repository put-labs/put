use {
    ...
    put_perf::packet::deserialize_from_with_limit,
    put_sdk::{clock::Slot, signature::Signature},
...
impl<'a> Shred<'a> for ShredData {
    ...
    fn from_payload(mut payload: Vec<u8>) -> Result<Self, Error> {
        ...
        // https://github.com/put-labs/put/pull/10109
        // https://github.com/put-labs/put/pull/16602
