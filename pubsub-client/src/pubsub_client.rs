...
//! subscriptions][spec].
//!
//! [spec]: https://docs.put.com/developing/clients/jsonrpc-api#subscription-websocket
//!
...
//! `--rpc-pubsub-enable-vote-subscription` to `put-validator`. When these
//! methods are disabled, the RPC server will return a "Method not found" error
//! message.
//!
//! [`block_subscribe`]: https://docs.rs/put-rpc/latest/put_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.block_subscribe
//! [`vote_subscribe`]: https://docs.rs/put-rpc/latest/put_rpc/rpc_pubsub/trait.RpcSolPubSub.html#tymethod.vote_subscribe
//!
//! # Examples
//!
...
//! use put_pubsub_client::pubsub_client::PubsubClient;
//! use put_rpc_client_api::config::RpcAccountInfoConfig;
//! use put_sdk::pubkey::Pubkey;
//! use std::thread;
//!
//! fn get_account_updates(account_pubkey: Pubkey) -> Result<()> {
//!     let url = "wss://api.devnet.put.com/";
//!
...
//! }
//! #
//! # get_account_updates(put_sdk::pubkey::new_rand());
//! # Ok::<(), anyhow::Error>(())
//! ```
    ...
    fn get_version(
        ...
        if let Ok(json_msg) = serde_json::from_str::<Map<String, Value>>(message_text) {
            if let Some(Object(version_map)) = json_msg.get("result") {
                if let Some(node_version) = version_map.get("put-core") {
...
impl PubsubClient {
    ...
    ///
    /// [`accountSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#accountsubscribe
    ...
    /// `--rpc-pubsub-enable-block-subscription` to `put-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`blockSubscribe`] RPC method.
    ///
    /// [`blockSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#blocksubscribe---unstable-disabled-by-default
    ...
    ///
    /// [`logsSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#logssubscribe
    ...
    ///
    /// [`programSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#programsubscribe
    ...
    ///
    /// This method is disabled by default. It can be enabled by passing
    /// `--rpc-pubsub-enable-vote-subscription` to `put-validator`.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`voteSubscribe`] RPC method.
    ///
    /// [`voteSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#votesubscribe---unstable-disabled-by-default
    ...
    /// validator.
    ///
    /// [root]: https://docs.put.com/terminology#root
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`rootSubscribe`] RPC method.
    ///
    /// [`rootSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#rootsubscribe
    ...
    ///
    /// [`signatureSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#signaturesubscribe
    ...
    ///
    /// [`slotSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#slotsubscribe
    ...
    ///
    /// [`slotUpdatesSubscribe`]: https://docs.put.com/developing/clients/jsonrpc-api#slotsupdatessubscribe---unstable
