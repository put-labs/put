...
pub enum LedgerError {
    #[error("PUT app not open on Ledger device")]
    ...
    #[error("Ledger received invalid PUT message")]
    PUTInvalidMessage = 0x6a80,

    #[error("Ledger received message with invalid header")]
    PUTInvalidMessageHeader = 0x6a81,

    #[error("Ledger received message in invalid format")]
    PUTInvalidMessageFormat = 0x6a82,

    #[error("Ledger received message with invalid size")]
    PUTInvalidMessageSize = 0x6a83,

    #[error("PUT summary finalization failed on Ledger device")]
    PUTSummaryFinalizeFailed = 0x6f00,

    #[error("PUT summary update failed on Ledger device")]
    PUTSummaryUpdateFailed = 0x6f01,
