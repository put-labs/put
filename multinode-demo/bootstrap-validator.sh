...
identity=$PUT_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$PUT_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$PUT_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
