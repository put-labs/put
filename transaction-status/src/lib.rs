...
pub use {crate::extract_memos::extract_and_fmt_memos, put_sdk::reward_type::RewardType};
use {
    crate::{
...
pub struct UiTransactionStatusMeta {
    ...
    pub status: TransactionResult<()>, // This field is deprecated.  See https://github.com/put-labs/put/issues/9302
