...
#[allow(deprecated)]
use put_rpc_client_api::deprecated_config::{
...
/// documentation.
///
/// [`Finalized`]: put_sdk::commitment_config::CommitmentLevel::Finalized
/// [`Processed`]: put_sdk::commitment_config::CommitmentLevel::Processed
/// [jsonprot]: https://docs.put.com/developing/clients/jsonrpc-api
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://docs.put.com/terminology#slot
/// [cl]: https://docs.put.com/developing/clients/jsonrpc-api#configuring-state-commitment
///
/// # Errors
///
/// Methods on `RpcClient` return
/// [`client_error::Result`][put_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][put_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][put_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][put_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][put_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use put_sdk::system_transaction;
/// # use put_rpc_client_api::client_error::Error;
/// # use put_rpc_client::rpc_client::RpcClient;
/// # use put_sdk::signature::{Keypair, Signer};
/// # use put_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = put_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
/// [`reqwest::Error`](put_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](put_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
///
/// [`ClientError`]: put_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: put_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: put_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: put_sdk::commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    /// # use put_sdk::commitment_config::CommitmentConfig;
    /// # use put_rpc_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    ///
    /// [`RpcError`]: put_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: put_rpc_client_api::request::RpcError::RpcResponseError
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: put_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: put_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: put_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`sendTransaction`]: https://docs.put.com/developing/clients/jsonrpc-api#sendtransaction
    /// [`getLatestBlockhash`]: https://docs.put.com/developing/clients/jsonrpc-api#getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`skip_preflight`]: put_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: put_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`getSignatureStatuses`]: https://docs.put.com/developing/clients/jsonrpc-api#getsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`err`]: put_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: put_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    /// Simulating a transaction is similar to the ["preflight check"] that is
    /// run by default when sending a transaction.
    ///
    /// ["preflight check"]: https://docs.put.com/developing/clients/jsonrpc-api#sendtransaction
    ///
    ...
    /// [`sig_verify`]: put_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ///
    /// [`simulateTransaction`]: https://docs.put.com/developing/clients/jsonrpc-api#simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`accounts`]: put_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: put_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://docs.put.com/developing/clients/jsonrpc-api#gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: put_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][put_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    /// This method is built on the [`getSignatureStatuses`] RPC method.
    ///
    /// [`getSignatureStatuses`]: https://docs.put.com/developing/clients/jsonrpc-api#gitsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlot`]: https://docs.put.com/developing/clients/jsonrpc-api#getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://docs.put.com/developing/clients/jsonrpc-api#getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://docs.put.com/developing/clients/jsonrpc-api#getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockProduction`]: https://docs.put.com/developing/clients/jsonrpc-api#getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://docs.put.com/developing/clients/jsonrpc-api#getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://docs.put.com/developing/clients/jsonrpc-api#getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://docs.put.com/developing/clients/jsonrpc-api#getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://docs.put.com/developing/clients/jsonrpc-api#getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://docs.put.com/developing/clients/jsonrpc-api#getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://docs.put.com/developing/clients/jsonrpc-api#getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// # use put_rpc_client_api::client_error::Error;
    /// # use put_rpc_client::rpc_client::RpcClient;
    /// # use put_transaction_status::UiTransactionEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    ///
    /// [`getBlocks`]: https://docs.put.com/developing/clients/jsonrpc-api#getblocks
    /// [`getConfirmedBlocks`]: https://docs.put.com/developing/clients/jsonrpc-api#getConfirmedblocks
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: put_sdk::commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method, unless
    ...
    ///
    /// [`getBlocksWithLimit`]: https://docs.put.com/developing/clients/jsonrpc-api#getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://docs.put.com/developing/clients/jsonrpc-api#getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSignaturesForAddress`]: https://docs.put.com/developing/clients/jsonrpc-api#getsignaturesforaddress
    /// [`getSignaturesForAddress2`]: https://docs.put.com/developing/clients/jsonrpc-api#getsignaturesforaddress2
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// ```
    /// # use put_rpc_client_api::client_error::Error;
    /// # use put_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use put_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     system_transaction,
    ...
    ///
    /// [`getTransaction`]: https://docs.put.com/developing/clients/jsonrpc-api#gettransaction
    /// [`getConfirmedTransaction`]: https://docs.put.com/developing/clients/jsonrpc-api#getconfirmedtransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockTime`]: https://docs.put.com/developing/clients/jsonrpc-api#getblocktime
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochInfo`]: https://docs.put.com/developing/clients/jsonrpc-api#getepochinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getLeaderSchedule`]: https://docs.put.com/developing/clients/jsonrpc-api#getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochSchedule`]: https://docs.put.com/developing/clients/jsonrpc-api#getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://docs.put.com/developing/clients/jsonrpc-api#getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPrioritizationFees`]: https://docs.put.com/developing/clients/jsonrpc-api#getrecentprioritizationfees
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://docs.put.com/developing/clients/jsonrpc-api#getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://docs.put.com/developing/clients/jsonrpc-api#getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://docs.put.com/developing/clients/jsonrpc-api#getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://docs.put.com/developing/clients/jsonrpc-api#getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the current put version running on the node.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getVersion`] RPC method.
    ///
    /// [`getVersion`]: https://docs.put.com/developing/clients/jsonrpc-api#getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.put_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://docs.put.com/developing/clients/jsonrpc-api#minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`RpcError::ForUser`]: put_rpc_client_api::request::RpcError::ForUser
    ...
    ///
    /// [`getAccountInfo`]: https://docs.put.com/developing/clients/jsonrpc-api#getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    /// # use put_rpc_client_api::client_error::Error;
    /// # use put_rpc_client::rpc_client::{self, RpcClient};
    /// # use put_sdk::{
    /// #     signature::Signer,
    /// #     signer::keypair::Keypair,
    /// #     pubkey::Pubkey,
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use put_account_decoder::UiAccountEncoding;
    /// # use std::str::FromStr;
    /// # let mocks = rpc_client::create_rpc_client_mocks();
    /// # let rpc_client = RpcClient::new_mock_with_mocks("succeeds".to_string(), mocks);
    /// let alice_pubkey = Pubkey::from_str("BgvYtJEfmZYdVKiptmMjxGzv8iQoo4MWjsP3QsTkhhxa").unwrap();
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://docs.put.com/developing/clients/jsonrpc-api#getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://docs.put.com/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://docs.put.com/developing/clients/jsonrpc-api#getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://docs.put.com/developing/clients/jsonrpc-api#getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://docs.put.com/developing/clients/jsonrpc-api#getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBalance`]: https://docs.put.com/developing/clients/jsonrpc-api#getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://docs.put.com/developing/clients/jsonrpc-api#getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use put_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
    ...
    ///
    /// [`getStakeMinimumDelegation`]: https://docs.put.com/developing/clients/jsonrpc-api#getstakeminimumdelegation
    ///
    /// # Examples
    ///
    /// ```
...
mod tests {
    use {
        ...
        put_rpc_client_api::client_error::ErrorKind,
        put_sdk::{
