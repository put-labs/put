...
use {
    ...
    put_rbpf::{elf::Executable, verifier::RequisiteVerifier, vm::BuiltinProgram},
    put_sdk::{
...
impl put_frozen_abi::abi_example::AbiExample for LoadedProgram {
    fn example() -> Self {
...
#[cfg(RUSTC_WITH_SPECIALIZATION)]
impl put_frozen_abi::abi_example::AbiExample for LoadedPrograms {
    fn example() -> Self {
...
mod tests {
    use {
        ...
        put_rbpf::vm::{BuiltinProgram, Config},
