...
use {
    ...
    put_gossip::gossip_service::discover_cluster,
    put_ledger::{
...
pub const RUST_LOG_FILTER: &str =
    "error,put_core::replay_stage=warn,put_local_cluster=info,local_cluster=info";

pub const DEFAULT_CLUSTER_LAMPORTS: u128 = 10_000_000 * LAMPORTS_PER_PUT;
pub const DEFAULT_NODE_STAKE: u128 = 10 * LAMPORTS_PER_PUT;
...
pub fn test_faulty_node(
    ...
    put_logger::setup_with_default("put_local_cluster=info");
    ...
    let validator_to_slots = vec![(
        ...
        put_sdk::clock::DEFAULT_DEV_SLOTS_PER_EPOCH as usize,
    )];
