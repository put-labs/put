use {
    ...
    log::*,
    put_ledger::entry_notifier_interface::EntryNotifierLock,
    put_rpc::{
        optimistically_confirmed_bank_tracker::SlotNotification,
        transaction_notifier_interface::TransactionNotifierLock,
    },
    put_runtime::accounts_update_notifier_interface::AccountsUpdateNotifier,
    std::{
        path::{Path, PathBuf},
        sync::{
...
impl GeyserPluginService {
    ...
    fn start_manager_rpc_handler(
        ...
        thread::Builder::new()
            .name("putGeyserPluginRpc".to_string())
            .spawn(move || loop {
