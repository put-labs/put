...
use {
    ...
    put_gossip::gossip_service::{discover_cluster, get_client, get_multi_client},
...
fn main() {
    ...
    put_metrics::set_panic_hook("bench-tps", /*version:*/ None);

    let matches = cli::build_args(put_version::version!()).get_matches();
